...
public class FeedService extends IntentService {
	...
	public static final String EXTRA_URL = "edu.mines.csci498.bwisdom.lunchlist.EXTRA_URL";
	public static final String EXTRA_MESSENGER ="edu.mines.csci498.bwisdom.lunchlist.EXTRA_MESSENGER";
	public FeedService() {
		super("FeedService");
	}
