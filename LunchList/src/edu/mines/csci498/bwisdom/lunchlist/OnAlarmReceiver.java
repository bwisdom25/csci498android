...
public class OnAlarmReceiver extends BroadcastReceiver{
	...
	private static final int NOTIFY_ME_ID = 69;
	...
	public void onReceive(Context ctxt, Intent intent) {
		...
		if(useNotification) {
			...
			Notification note = new Notification(R.drawable.stat_notify_chat,ctxt.getString(R.string.alarmText),System.currentTimeMillis());
			
			PendingIntent i = PendingIntent.getActivity(ctxt, 0, new Intent(ctxt,AlarmActivity.class), 0);
			
			note.setLatestEventInfo(ctxt, ctxt.getString(R.string.app_name), ctxt.getString(R.string.alarmNote), i);
